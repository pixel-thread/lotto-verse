...
export const UpdateModal: React.FC = () => {
  const { release, isMandetory, isLoading, isNewReleaseAvailable, currentVersion } =
    useUpdateContext();
  ...
  const getUpdateButtonText = () => {
    switch (updateState) {
      ...
      case 'error':
        return 'Retry Update';
      default:
        return release?.type === 'PTA' ? 'Update Now' : 'Install Update';
    }
  };
  ...
  return (
    <Modal
      ...
      hardwareAccelerated>
      <TouchableWithoutFeedback onPress={isMandetory ? undefined : handleRemindLater}>
              ...
              <ScrollView className="max-h-96 px-6" showsVerticalScrollIndicator={false}>
                ...
                {release?.releaseNotesUrl && (
                  <View className="mb-5">
                    ...
                    <Text className="text-base capitalize leading-6 text-neutral-600 dark:text-neutral-300">
                      {release.description}
                    </Text>
                  </View>
                )}
